...
const struct GameInfo	Model3GameList[] =
{
	// Virtua Fighter 3
	{
		...
		GAME_INPUT_JOYSTICK1|GAME_INPUT_FIGHTING,
	...
	// Le Mans 24
	{
		...
		TRUE,		// 64 MB of banked CROM (needs to be mirrored)
		0x2000000,	// 32 MB of VROM (will need to be mirrored)
		GAME_INPUT_VEHICLE|GAME_INPUT_VR|GAME_INPUT_SHIFT4,	// for now, Shift Up/Down mapped to Shift 3/4
	...
	// Scud Race
	{
		...
		TRUE,		// 64 MB of banked CROM (needs to be mirrored)
		0x2000000,	// 32 MB of VROM (will need to be mirrored)
		GAME_INPUT_VEHICLE|GAME_INPUT_VR|GAME_INPUT_SHIFT4,
	...
	// Virtua Striker 2 '98
	{
		...
		TRUE,		// 64 MB of banked CROM (needs to be mirrored)
		0x2000000,	// 32 MB of VROM
		GAME_INPUT_JOYSTICK1|GAME_INPUT_SOCCER,
	...
	// Sega Rally 2
	{
		...
		TRUE,		// 64 MB of banked CROM (needs to be mirrored)
		0x4000000,	// 64 MB of VROM
		GAME_INPUT_VEHICLE|GAME_INPUT_RALLY|GAME_INPUT_SHIFT4,
