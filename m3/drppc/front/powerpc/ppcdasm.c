...
#define D_X5(xo)	((xo & 0x1F) << 1)
#define D_X6(xo)	((xo & 0x3F) << 1)
...
#define G_PSW(op)	((op >> 15) & 1)
#define G_PSI(op)	((op >> 12) & 7)
...
static IDESCR itab[] =
{
	...
	{ "psq_l",		D_OP(56),			0x03FFFFFF,				F_PSQ,			0			},
	{ "psq_lu",		D_OP(57),			0x03FFFFFF,				F_PSQ,			0			},
	{ "psq_st",		D_OP(60),			0x03FFFFFF,				F_PSQ,			0			},
	{ "psq_stu",	D_OP(61),			0x03FFFFFF,				F_PSQ,			0			},

	{ "ps_abs",		D_OP(4)|D_XO(264),	M_RT|M_RB|M_RC,			F_PS_T_B,		FL_RC		},
	{ "ps_add",		D_OP(4)|D_X5(21),	M_RT|M_RA|M_RB|M_RC,	F_PS_T_A_B,		FL_RC		},
	{ "ps_cmpu0",	D_OP(4)|D_XO(0),	M_CRBD|M_RA|M_RB,		F_PS_CMP,		0			},
	{ "ps_cmpo0",	D_OP(4)|D_XO(32),	M_CRBD|M_RA|M_RB,		F_PS_CMP,		0			},
	{ "ps_cmpu1",	D_OP(4)|D_XO(64),	M_CRBD|M_RA|M_RB,		F_PS_CMP,		0			},
	{ "ps_cmpo1",	D_OP(4)|D_XO(96),	M_CRBD|M_RA|M_RB,		F_PS_CMP,		0			},
	{ "ps_div",		D_OP(4)|D_X5(18),	M_RT|M_RA|M_RB|M_RC,	F_PS_T_A_B,		FL_RC		},
	{ "ps_madd",	D_OP(4)|D_X5(29),	M_RT|M_RA|M_RB|M_REGC|M_RC,	F_PS_MADD,	FL_RC		},
	{ "ps_madds0",	D_OP(4)|D_X5(14),	M_RT|M_RA|M_RB|M_REGC|M_RC,	F_PS_MADD,	FL_RC		},
	{ "ps_madds1",	D_OP(4)|D_X5(15),	M_RT|M_RA|M_RB|M_REGC|M_RC,	F_PS_MADD,	FL_RC		},
	{ "ps_merge00",	D_OP(4)|D_XO(528),	M_RT|M_RA|M_RB|M_RC,	F_FRT_FRA_FRB,	FL_RC		},
	{ "ps_merge01",	D_OP(4)|D_XO(560),	M_RT|M_RA|M_RB|M_RC,	F_FRT_FRA_FRB,	FL_RC		},
	{ "ps_merge10",	D_OP(4)|D_XO(592),	M_RT|M_RA|M_RB|M_RC,	F_FRT_FRA_FRB,	FL_RC		},
	{ "ps_merge11",	D_OP(4)|D_XO(624),	M_RT|M_RA|M_RB|M_RC,	F_FRT_FRA_FRB,	FL_RC		},
	{ "ps_mr",		D_OP(4)|D_XO(72),	M_RT|M_RB,				F_PS_T_B,		FL_RC		},
	{ "ps_msub",	D_OP(4)|D_X5(28),	M_RT|M_RA|M_RB|M_REGC|M_RC,	F_PS_MADD,	FL_RC		},
	{ "ps_mul",		D_OP(4)|D_X5(25),	M_RT|M_RA|M_REGC|M_RC,	F_PS_T_A_C,		FL_RC		},
	{ "ps_muls0",	D_OP(4)|D_X5(12),	M_RT|M_RA|M_REGC|M_RC,	F_PS_T_A_C,		FL_RC		},
	{ "ps_muls1",	D_OP(4)|D_X5(13),	M_RT|M_RA|M_REGC|M_RC,	F_PS_T_A_C,		FL_RC		},
	{ "ps_nabs",	D_OP(4)|D_XO(136),	M_RT|M_RB|M_RC,			F_PS_T_B,		FL_RC		},
	{ "ps_neg",		D_OP(4)|D_XO(40),	M_RT|M_RB|M_RC,			F_PS_T_B,		FL_RC		},
	{ "ps_nmadd",	D_OP(4)|D_X5(31),	M_RT|M_RA|M_RB|M_REGC|M_RC,	F_PS_MADD,	FL_RC		},
	{ "ps_nmsub",	D_OP(4)|D_X5(30),	M_RT|M_RA|M_RB|M_REGC|M_RC,	F_PS_MADD,	FL_RC		},
	{ "ps_res",		D_OP(4)|D_X5(24),	M_RT|M_RB|M_RC,			F_PS_T_B,		FL_RC		},
	{ "ps_rsqrte",	D_OP(4)|D_X5(26),	M_RT|M_RB|M_RC,			F_PS_T_B,		FL_RC		},
	{ "ps_sel",		D_OP(4)|D_X5(23),	M_RT|M_RA|M_RB|M_REGC|M_RC,	F_PS_MADD,	FL_RC		},
	{ "ps_sub",		D_OP(4)|D_X5(20),	M_RT|M_RA|M_RB|M_RC,	F_PS_T_A_B,		FL_RC		},
	{ "ps_sum0",	D_OP(4)|D_X5(10),	M_RT|M_RA|M_RB|M_REGC|M_RC,	F_PS_MADD,	FL_RC		},
	{ "ps_sum1",	D_OP(4)|D_X5(11),	M_RT|M_RA|M_RB|M_REGC|M_RC,	F_PS_MADD,	FL_RC		},
};
 ...
 *
 * Stefano: I changed from SPR() to DisasmSPR() not to interfere with the SPR
 * macro defined in internal.h. I didn't name it DecodeSPR() because we may
 * want such an identifier reserved for the PowerPC decoder.
 */

static void DisasmSPR(CHAR *dest, UINT spr_field)
{
    UINT    spr;
...
static BOOL Check(UINT32 op, UINT flags)
{
    UINT    nb, rt, ra;
                        ...
                        BOOL use_simple)
{
    ...
    for (i = 0; i < sizeof(itab) / sizeof(IDESCR); i++)
    {
        if ((op & ~itab[i].mask) == itab[i].match)  // check for match
        {
			...
			case F_PSQ:
				if (G_RA(op))
					sprintf(oprs, "f%d,%s(r%d),%i,%i", G_RT(op), signed16, G_RA(op), G_PSW(op), G_PSI(op));
				else
					sprintf(oprs, "f%d,0x%08X,%i,%i", G_RT(op), (UINT32) ((INT16) G_D(op)), G_PSW(op), G_PSI(op));
				break;

			case F_PS_T_B:
				sprintf(oprs, "f%d,f%d", G_RT(op), G_RA(op));
				break;
			...
			case F_PS_MADD:
				sprintf(oprs, "f%d,f%d,f%d,f%d", G_RT(op), G_RA(op), G_RB(op), G_REGC(op));
				break;
...
static void PrintInterpTable(void)
{
	CHAR mnem[16];
	UINT i, len;
	...
	{
		strcpy(mnem, itab[i].mnem);
		len = strlen(mnem);

		/*
		 * Change the trailing '.' with '_'.
		 */
		...
		/*
		 * Add an x to the end of the instruction if RC/OE/AA/LK bits are used.
		 */

		if (itab[i].flags & FL_OE || itab[i].flags & FL_RC ||
			itab[i].flags & FL_LK || itab[i].flags & FL_AA)
		{
			mnem[len] = 'x';
			mnem[++len] = '\0';
		}

		printf("\t{ 0x%08X, 0x%08X, ppc_%s\t},\n", ~itab[i].mask, itab[i].match, mnem);
	}
}
...
static void PrintUsage(void)
{
	...
	puts("          -table      Print an instruction table useable by the interpreter");
    exit(0);
}
